...
var sharedInstance = nil,
    CrysonVersionFieldKey = @"crysonVersionAttribute";
...
- (CPString)versionFieldNameForClass:(CLASS)crysonEntityClass
{
  return [[self findDefinitionForClass:crysonEntityClass] objectForKey:CrysonVersionFieldKey];
}
